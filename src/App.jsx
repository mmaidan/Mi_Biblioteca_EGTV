      ...
      <header style={{ background: "#1F3A2E", borderBottom: "6px solid #B08D57" }} className="px-6 py-6 sm:px-10">
        <div className="max-w-5xl mx-auto flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <h1 className="font-display text-3xl sm:text-4xl font-semibold flex items-center gap-2.5" style={{ color: "#FFFDF8" }}>
              <Library size={28} style={{ color: "#B08D57" }} />
              Mi Biblioteca
            </h1>
          </div>
  ...
  return (
    <div style={{ background: "#1F3A2E", minHeight: "100vh", fontFamily: "'Source Serif 4', Georgia, serif" }} className="flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm rounded-sm border-2 p-7" style={{ background: "#FFFDF8", borderColor: "#B08D57" }}>
        <div className="flex items-center gap-2 mb-1" style={{ color: "#7A2E2E" }}>
          <ShieldCheck size={18} />
          <span className="font-mono text-[11px] uppercase tracking-widest">Acceso al catálogo</span>
        </div>
        <h1 className="font-display text-2xl font-semibold mb-5" style={{ color: "#1F3A2E" }}>
          Mi Biblioteca
        </h1>
